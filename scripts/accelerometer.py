...
class IMU:
    def __init__(self, bus_num = 1, imu_addr):
    ...
    def initialize_imu(self):
        ...
        try:
            ...
            print('Initializarion successful.')
    ...
    def calc_position(self, x, y, z):
        ...
        '''
        # assuming the accelerometer is set to +/- 2g.
        # where +/- 1g translates to 16384 LSB/g (least significant bits per g).
        # 16384 = 2^14 because the accelerometer data for each axis is 16-bit (2 bytes, 6 bytes total).
        ax = x / 16384.0 
        ay = y / 16384.0
        az = z / 16384.0
